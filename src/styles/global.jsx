...
export function GlobalStyles({ isRTL }) {
  return (
    <style>{`
      :root {
        --primary-gold: ${T.gold};
        --primary-accent: ${T.goldBright};
        --primary-dim: ${T.goldDim};
        --bg-primary: ${T.bg};
        --bg-surface: ${T.surface};
      }
      *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
      html,body,#root{height:100%}
      body{font-family:${isRTL ? AF : T.sans};background:var(--bg-primary);color:${T.black};font-size:13px;line-height:1.55;overflow:hidden}
      ...
      .sl{animation:slideUp .35s cubic-bezier(0.16,1,0.3,1) both}
      .sid{animation:slideInDown .2s ease both}
